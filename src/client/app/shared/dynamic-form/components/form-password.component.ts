...
<div class="ms-TextField" [formGroup]="group">
    ...
    <input type="password" [formControlName]="field.name" [id]="field.key" [attr.placeholder]="field.placeholder" class="ms-TextField-field">
</div>
<div *ngIf="invalid" class="ms-TextField-description">{{field.label}} is required</div>
    `
})
export class FormPasswordComponent extends FormField implements AfterViewInit {
